...
You should end up with a new folder called **`shell-lesson-data`** in your user directory for the class.
You should end up certain files within the folder **`files`** in your user directory for the class.
